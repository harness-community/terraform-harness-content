...
variable "name" {
  type        = string
  description = "[Required] Provide an Input Set name. Must be at least 1 character but but less than 128 characters"
  ...
  validation {
    ...
    error_message = <<EOF
        Validation of an object failed.
            * [Required] Provide an Input Set name. Must be at least 1 character but but less than 128 characters.
        EOF
  }
}
...
variable "description" {
  ...
  default     = "Harness Input Set created via Terraform"
  ...
  validation {
    ...
    error_message = <<EOF
        Validation of an object failed.
            * [Optional] Provide an Input Set description.  Must be six or more characters.
        EOF
  }
}
