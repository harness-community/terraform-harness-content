...
variable "name" {
  type        = string
  description = "[Required] Provide a Pipeline name. Must be at least 1 character but but less than 128 characters"
  ...
  validation {
    ...
    error_message = <<EOF
        Validation of an object failed.
            * [Required] Provide a Pipeline name. Must be at least 1 character but but less than 128 characters.
        EOF
  }
}
